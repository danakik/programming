...
@pytest.mark.parametrize('input_param_1, input_param_2, input_param_3, expected', [(2, 2, '+', 4), (5, 2, '-', 3), (2, 0, '/', "Division by zero!"), (6, 2, '/', 3), \
...
def test_iinput_validation_operator(input_param, expected):
